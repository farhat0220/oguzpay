                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_balance_enquiries.php">Maliýeler</a></li>
                                    <li class="breadcrumb-item"><a href="pages_balance_enquiries.php">Balans</a></li>
                                    <li class="breadcrumb-item active"><?php echo $row->name; ?> Hasaplar</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                                    ...
                                    <table id="example1" class="table table-hover table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Ady</th>
                                                <th>Hasabyň belgisi</th>
                                                <th>Göterim</th>
                                                <th>Hasabyň görnüşi</th>
                                                <th>Hasabyň eýesi</th>
                                                <th>Açylan senesi</th>
                                                <th>Hereket</th>
                                            </tr>

            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><?php echo $row->client_name; ?> Hasabyň balansy</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dolandyryş paneli</a></li>
                                    <li class="breadcrumb-item"><a href="pages_balance_enquiries.php">Maliýe</a></li>
                                    <li class="breadcrumb-item"><a href="pages_balance_enquiries.php">Balans</a></li>
                                    <li class="breadcrumb-item active"><?php echo $row->client_name; ?> Hasaplar</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-12">
                                ...
                                <div id="balanceSheet" class="invoice p-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>
                                                <i class="fas fa-bank"></i> iBanking Balansy sora
                                                <small class="float-right">Sene: <?php echo date('d/m/Y'); ?></small>
                                            </h4>
                                        </div>
                                        <!-- /.col -->
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-6 invoice-col">
                                            ...
                                            <address>
                                                ...
                                                Telefon: <?php echo $row->client_phone; ?><br>
                                                ID No: <?php echo $row->client_national_id; ?>
                                            </address>
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-6 invoice-col">
                                            Hasabyň maglumatlary
                                            <address>
                                                <strong><?php echo $row->acc_name; ?></strong><br>
                                                Hasap No: <?php echo $row->account_number; ?><br>
                                                Hasabyň görnüşi: <?php echo $row->acc_type; ?><br>
                                                Hasabyň göterimi: <?php echo $row->acc_rates; ?> %
                                            </address>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- /.col -->
                                        <div class="col-6">
                                            <p class="lead">Balansy barlandy : <?php echo date('d-M-Y'); ?></p>

                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <th style="width:50%">Geçirilenler:</th>
                                                        <td>$ <?php echo $deposit; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Çekimler</th>

          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="">Açar sözi täzele</a></li>
                <li class="breadcrumb-item active">Dolandyrmak</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Açar sözi täzeden düzmek üçin islendigini saýlaň</h3>
              </div>
              <div class="card-body">

    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Açar sözi ýatdan çykardyňmy? Açar sözi täzelemek!</p>
          ...
          <form method="POST">
            ...
            <div class="row">
              <div class="col-12">
                <button type="submit" name="reset_password" class="btn btn-success btn-block">Açar sözi täzelemek</button>
              </div>
              <!-- /.col -->
            </div>
          </form>
          ...
          <p class="mt-3 mb-1">
            <a href="pages_client_index.php">Girmek</a>
          </p>

            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Open <?php echo $row->name; ?> iBanking Hasab</h1>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi telefon nomeri</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Hasybyň görnüşi</label>
                                                    <select class="form-control" onChange="getiBankAccs(this.value);" name="acc_type">
                                                        <option>Hasabyň görnüşini saýlaň</option>
                                                        <?php
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Hasabyň görnuşi göterimde (%)</label>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="open_account" class="btn btn-success">iBanking hasap açmak</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->

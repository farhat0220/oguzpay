            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Open <?php echo $row->name; ?> iBanking Hasap</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">Açmak </a></li>
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi Adresi</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">iBank Hasabyň görnüşi</label>
                                                    <select class="form-control" onChange="getiBankAccs(this.value);" name="acc_type">
                                                        <option>Islendik iBank hasaby saýlaň</option>
                                                        <?php
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="open_account" class="btn btn-success">iBank hasaby açmak</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->

          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="pages_manage_staff.php">iBank Işgärler</a></li>
                <li class="breadcrumb-item active">Işgärleri dolandyrmak</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Işgärleri üýtgetmek üçin saýlaň</h3>
              </div>
              <div class="card-body">

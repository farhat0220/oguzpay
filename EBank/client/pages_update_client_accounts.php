            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update <?php echo $row->client_name; ?> iBanking Hasap</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dolandyryş paneli</a></li>
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">iBanking Hasaplar</a></li>
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">Dolandyryş </a></li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-purple">
                                    <div class="card-header">
                                        <h3 class="card-title">Ähli boşluklary dolduryň</h3>
                                    </div>
                                    <!-- form start -->
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi ady</label>
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputPassword1">Müşderi belgisi</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi telefon belgisi</label>
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputPassword1">Müşderi halkara belgisi (ID)</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi Email</label>
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Müşderi Address</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Hasabyň görnüşi</label>
                                                    <select class="form-control" onChange="getiBankAccs(this.value);" name="acc_type">
                                                        <option>Hasabyň görnuşini saýlaň</option>
                                                        <?php
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="update_account" class="btn btn-success">iBanking Hasaby täzeli</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->

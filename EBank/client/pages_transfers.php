          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="pages_transfers">iBank Maliýe</a></li>
                <li class="breadcrumb-item active">Geçirimler</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Serişdeleri geçirmek üçin islendik hasaplardan saýlaň</h3>
              </div>
              <div class="card-body">

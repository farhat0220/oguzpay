                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_deposits">iBank Maliýesi</a></li>
                                    <li class="breadcrumb-item"><a href="pages_deposits">Pul Çekmek</a></li>
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-4 form-group">
                                                    <label for="exampleInputPassword1">Hasabyň belgisi</label>
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">Geçirim kody</label>
                                                    <?php
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="withdrawal" class="btn btn-success">Pul çekip almak</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->

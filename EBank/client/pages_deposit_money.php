                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dilandyryş paneli</a></li>
                                    <li class="breadcrumb-item"><a href="pages_deposits">iBank Maliýe</a></li>
                                    <li class="breadcrumb-item"><a href="pages_deposits">Depozit</a></li>

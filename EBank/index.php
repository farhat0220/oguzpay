...
?>
    ...
    <header id="header" class="fixed-top ">
        ...
        <a href="index.php" class="logo"><img src="assets/img/Logo3.png" alt="" class="img-fluid"> &nbsp Oguzpay Banking</a>
        <!-- <h1 class="logo"><a href="index.html">OGUZPAY</a></h1> -->

        <nav id="navbar" class="navbar">
            <ul>
            <li><a class="nav-link scrollto active" href="#hero">Baş Sahypa</a></li>
            <li><a class="nav-link scrollto " href="client/pages_client_index.php">Müşderiler</a></li>
            <li><a class="nav-link scrollto" href="staff/pages_staff_index.php">Işgärler</a></li>
            <!-- <li><a class="nav-link scrollto" href="#team">Blog</a></li> -->
            <li><a class="nav-link scrollto" href="about.html">Maglumatlar</a></li>
            ...
            <!--<li><a class="nav-link scrollto" href="contact.php">Habarlaşmak</a></li>-->
            <li><a class="getstarted scrollto" href="client/pages_client_index.php">&nbsp Girmek &nbsp</a></li>
            </ul>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row justify-content-center">
            ...
            <h1>Pul Tölemegiň aňsat ýoly</h1>
            <h2>Iň ynamly tolegler </h2>
            <div class="heroBtn">
                <div><a href="client/pages_client_signup.php" class="btn-get-started scrollto">Başla</a></div>
                ...
                <div><a href="client/pages_client_index.php" class="btn-get-started scrollto">&nbsp &nbsp &nbsp Girmek &nbsp &nbsp &nbsp</a></div>
            </div>
    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                <h3>iBank ulgama girmek üçin gerekli maglumatlar</h3>
                <p class="font-italic">
                You just need to follow 4 steps to start banking with us. Lets introduce to you with account creation steps.
                </p>
                <ul>
                <li><i class="bi bi-check-circle"></i> Müşderiň doly ady</li>
                <li><i class="bi bi-check-circle"></i> Halkara belgisi (ID)</li>
                <li><i class="bi bi-check-circle"></i> Müşderiň adresi we Telefon belgisi</li>
                <li><i class="bi bi-check-circle"></i> E-mail we Açar sözi.</li>
                </ul>
                <a href="onlineBanking.html" class="read-more">Beýleki maglumatlar<i class="bi bi-long-arrow-right"></i></a>
            </div>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="testimonial-item">
                    ...
                    OGUZPAY is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
                ...
                <div class="testimonial-item">
                    <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    The Transaction system of the OGUZPAY is very fast. We can easily manage our transaction history
                ...
                <div class="testimonial-item">
                    ...
                    and start your online banking. Thank You OGUZPAY!
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                    </p>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <ul>
                ...
                <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">What’s the document required for KYC ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
    ...
    <footer id="footer">
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 footer-newsletter">
                ...
                <h1 class="text-center mt-2">OGUZPAY</h1>
            </div>
        ...
        <div class="copyright-wrap d-md-flex py-4">
            ...
            <div class="copyright">
                &copy; Copyright <strong><span>OGUZPAY</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
